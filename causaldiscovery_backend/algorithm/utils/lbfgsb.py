...
class LBFGSB(Optimizer):
    ...
    def _subspace_min(self,g,xc,c):
        ...
        # Fix for PyTorch 1.9+: lstsq returns named tuple, only need solution
        lstsq_result = torch.linalg.lstsq(N, v, rcond=None)
        v = lstsq_result.solution if hasattr(lstsq_result, 'solution') else lstsq_result[0]
